...
CREATE TABLE `test_cases` (
	...
	CONSTRAINT `test_cases_case_code_unique` UNIQUE(`case_code`)
);
--> statement-breakpoint
...
ALTER TABLE `test_results` ADD CONSTRAINT `test_results_build_id_automation_builds_id_fk` FOREIGN KEY (`build_id`) REFERENCES `automation_builds`(`id`) ON DELETE cascade ON UPDATE no action;