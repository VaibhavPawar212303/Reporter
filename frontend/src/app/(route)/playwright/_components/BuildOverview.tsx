...
import { BuildHistoryComparison } from "./BuildHistoryComparison"; // 🟢 Import the comparison component
...
export function BuildOverview({ buildId, buildData, historyData = [] }: { buildId: any, buildData: any, historyData?: any[] }) {
    ...
    return (
        <div className="space-y-6">
                    ...
                    <div className="lg:col-span-4 p-6 flex items-center gap-8 bg-emerald-500/[0.02]">
                        <div className="w-28 h-28 relative shrink-0">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                <span className="text-xl font-black tabular-nums text-white leading-none">{stabilityIndex}%</span>
            ...
            {/* 🟢 CROSS-BUILD PERFORMANCE REGISTRY (Added at the end) */}
